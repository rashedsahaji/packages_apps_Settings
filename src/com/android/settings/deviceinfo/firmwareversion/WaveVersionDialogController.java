...
public class WaveVersionDialogController  implements View.OnClickListener {
    ...
    @VisibleForTesting
    static final int WAVE_VERSION_VALUE_ID = R.id.wave_version_value;
    @VisibleForTesting
    static final int WAVE_VERSION_LABEL_ID = R.id.wave_version_label;
    ...
    public void initialize() {
        ...
        mDialog.setText(WAVE_VERSION_VALUE_ID,
                BidiFormatter.getInstance().unicodeWrap(Build.WAVE_DISPLAY_VERSION));
    }

    private void registerClickListeners() {
        mDialog.registerClickListener(WAVE_VERSION_LABEL_ID, this /* listener */);
        mDialog.registerClickListener(WAVE_VERSION_VALUE_ID, this /* listener */);
    }
